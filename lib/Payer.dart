...
class PrayerTimesScreen3 extends StatefulWidget {
  @override
  _PrayerTimesScreen3State createState() => _PrayerTimesScreen3State();
}

class _PrayerTimesScreen3State extends State<PrayerTimesScreen3> {
          ...
          title: ''
              ,              content: Column(
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: (){
Speek.play=!Speek.play;                              Speek().speak("توقيت صلاة"+
                                  translatePrayer(entry.key, localizations) +
                                      formatDuration(_timeToDuration(entry.value))
                              );
...
// تحويل الوقت إلى Duration
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.spatial_audio_sharp, color: AppColor.primaryColor, size: 24),
                                  SizedBox(width: 15),
                                  Text(
                                    "نطق الوقت",
